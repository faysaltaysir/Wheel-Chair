...
String apiKey = "2036178";              //Add your Token number that bot has sent you on WhatsApp messenger
String phone_number = "8801644529856"; //Add your WhatsApp app registered phone number (same number that bot send you in url)
...
void loop()
{
  ...
  Serial.print("SonerRead  ");
  Serial.println(readSoner_1());
  
  Serial.print("SonerRead2  ");
  Serial.println(readSoner_2());
  if(readSoner_1()>7){
    //motorStop();
  }
  if(readSoner_2()>7){
